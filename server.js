...
const app = express();
app.use(express.json({ limit: '10mb' })); // Increase JSON size limit for large Base64 images
app.use(cors());
...
// ✅ Define Image Schema (Base64 Storage)
const ImageSchema = new mongoose.Schema({
    imageBase64: { type: String, required: true }, // Store image as Base64
...
app.post('/upload', async (req, res) => {
    try {
        ...
        const newImage = new Image({ imageBase64, description });
        await newImage.save();
